...
def display(total, w, y, x):
	if total < 15:
		w.addstr(y, x-10, str(total) + " Points?? Seriously!!! Please don't humiliate")
		w.addstr(y+2, x, "yourself infront of others")
	elif total < 20:
		w.addstr(y, x, "Lol! You Loser!!")
		w.addstr(y+2, x-10, "Go home and practice hard, slow hands")
	elif total < 25:
		w.addstr(y, x-6, "My grandma can play better than you")
		w.addstr(y+2, x-3, "You can cry in the corner!")
		w.addstr(2*y-4, x*3-4, "HERE")
	elif total < 30:
		w.addstr(y, x-9, "Wowww, " + str(total) + "!! " + "Go mention in your resume :/" )
		w.addstr(y+2, x, " * SLOW CLAPS * ")
	else:
		w.addstr(y, x-10, "Congrats!! You had a really shitty childhood")
...
while True:
	w.addstr(0, sw/3, "SCORE: " + str(total))
	prev_key = key
	next_key = w.getch()
